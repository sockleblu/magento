...
shared_config = {
    ...
    'user' => 'ubuntu',
    'urls' => [
        'preview.zumiez.ca', # this for magento_test
        # "preview1.zumiez.ca",
        'previewsold.zumiez.ca', # ,
        # "preview5.zumiez.ca",
        # "previewsold5.zumiez.ca"
    ],
    'mysql' => {
        'host' => "preview_host",
    ...
    'cache' => {
        'host' => 'cache-preview.aws.zumiez.ca',
        'port' => '6701',
    },
    'middleware' => {
        'fqdn' => "middleware-preview.aws.zumiez.ca'",
    },
}
