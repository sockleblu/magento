...
#================================
shared_config = {
    'devel_stage' => 'acceptance',
    'mage_run_code' => 'base',
    'user' => 'deploy',
    'urls' => [
        'acceptance.zumiez.com',
        'sold.acceptance.zumiez.com',
    ],
    'ssmtp' => {
        'hostname' => 'acceptance_host',
    ...
    'mysql' => {
        'host' => 'acceptance_host',
        'username' => 'acceptance_user',
        'password' => 'acceptance_pass',
        'database' => 'acceptance_data',
    },
    'cache' => {
      'host' => 'acceptance-cache',
      'port' => '6383',
      'log_level' => '6',
      'retries' => '2',
    ...
    'middleware' => {
        'fqdn' => 'middleware-acceptance.zumiez.com',
        'enable_write' => '0',
    },
}
