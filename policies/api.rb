...
cookbook 'base',	   git: 'git@git.zumiez.com:cookbooks/base.git', branch: 'main'
cookbook 'devops_base',    '~> 0.2.0'
cookbook 'magento_webapp', '~> 0.1.0'
cookbook 'magento_deploy', '~> 0.1.0'
cookbook 'magento_middleware', git: 'git@git.zumiez.com:cookbooks/magento_middleware.git', branch: 'main'
